...
const roleCopy = {
  ...
  venue: {
    ...
    stripeDescription: 'Connect Stripe so 3rdSpace can route venue payments and payouts.',
  ...
  vendor: {
    ...
    displayLabel: 'Contact name',
    stripeDescription: 'Connect Stripe so 3rdSpace can route vendor payments and payouts.',
