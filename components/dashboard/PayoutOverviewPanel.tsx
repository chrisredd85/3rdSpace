...
const roleConfig = {
  builder: {
    title: 'Payouts',
    description: 'Community Host Incentives and builder payout readiness',
    ...
    pendingLabel: 'Pending incentives',
    completedLabel: 'Paid to builder',
    emptyLabel: 'No incentives yet',
    summaryUnit: 'cents',
  },
  venue: {
    title: 'Payouts',
    description: 'Venue payout readiness and qualified Community Host Incentives',
    summaryUrl: '/api/venue/community-host-incentive/summary',
