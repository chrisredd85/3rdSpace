    ...
    <div className={cn('flex min-h-[calc(100vh-2rem)] items-center justify-center px-4 py-10', className)}>
      <div className="w-full max-w-3xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-balance font-display text-3xl font-bold leading-tight sm:text-4xl">What 3rdSpace do you want to create?</h1>
        ...
        <div className="mt-4 flex flex-col gap-2 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          ...
          <span className="shrink-0 text-right">Powered by 3rdSpace Agent v2.4</span>
        </div>
      </div>
    </div>
  )
