  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <textarea
        ...
        rows={4}
        maxLength={1200}
        className="w-full rounded-lg border border-tan px-3 py-2 text-sm focus:border-clay focus:outline-none focus:ring-2 focus:ring-clay/20"
        placeholder="Thank the builder or add context for future clients."
        required
      />
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-xs text-ink-soft">{responseText.length}/1200 characters</p>
