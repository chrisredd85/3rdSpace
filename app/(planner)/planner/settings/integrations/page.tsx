    ...
    <div className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        <div>
          ...
          <h1 className="mt-2 font-display text-3xl font-bold text-foreground">Integrations</h1>
        </div>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">Creator sender for venue and vendor outreach</p>
                </div>
              </div>
              {account ? (
          ...
          <CardContent className="space-y-5 pt-6">
            {isLoading ? (
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Button type="button" variant="glass" onClick={disconnect} disabled={isDisconnecting}>
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <p className="max-w-xl text-sm text-muted-foreground">
                  Connect Gmail before sending approved outreach drafts.
                </p>
