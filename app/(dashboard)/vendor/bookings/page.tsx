...
import { useVendorBookingRequests } from '@/lib/hooks/useBookings'
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Manage incoming booking requests for your services</p>
      </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  ...
                  Respond within 24 hours to maintain your response rate and keep your profile active.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <div>
                  <p className="text-gray-600">Your Fee</p>
                  <p className="font-medium">
            ...
            {booking.notes && (
              <div className="mb-4">
                <p className="text-xs font-medium text-gray-700 mb-1">Service Details:</p>
