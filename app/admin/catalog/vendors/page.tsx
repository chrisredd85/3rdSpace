...
/**
 * Admin vendor catalog seeding and review page.
 */
export default async function AdminVendorCatalogPage() {
  ...
  return <AdminCatalogConsole kind="vendors" initialRows={(data ?? []) as Array<Record<string, any>>} />
}
