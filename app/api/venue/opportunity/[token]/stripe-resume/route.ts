...
export async function GET(request: NextRequest, context: RouteContext) {
  try {
    ...
    const result = await startVenueOpportunityStripeResume(admin, request, context.params.token)
    ...
    const url = new URL(`/venue/opportunity/${encodeURIComponent(context.params.token)}/stripe-complete`, request.url)
