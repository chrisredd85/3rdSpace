...
export const SPECIAL_SUPPLY_PACKS: Record<SpecialSupplyKind, SpecialSupplyPack> = {
  ...
  golf_activity: {
    id: 'special_supply_golf_activity',
    kind: 'golf_activity',
    label: 'Golf activity',
    leadLabel: 'Golf venue or activity operator',
    candidateStatusLabel: 'Unverified golf activity lead - quote required',
    searchTerms: ['indoor golf venue', 'golf driving range', 'golf course private event', 'golf simulator event'],
    intakeQuestions: [
      'Should I scout full courses, driving ranges, indoor simulators, or keep all golf options open?',
      'Which city or neighborhood should the golf search start in?',
      'What guest count, date, start time, and event duration should quotes assume?',
      'Do you need food, drinks, instruction, clubs, tournament format, or reserved bays included?',
      'Do you already have a course, range, simulator, or booking link you want compared?',
    ],
    quoteComparisonFields: [
      'all-in event price',
      'capacity or bay count',
      'included play time',
      'food and beverage minimum',
      'included equipment',
      'instruction or host staff',
      'deposit',
      'cancellation terms',
      'weather or indoor fallback',
      'hold deadline',
      'expected profit at ticket prices',
    ],
    outreachQuoteFields: [
...
const SPECIAL_SUPPLY_PATTERNS: Array<{ kind: SpecialSupplyKind; patterns: RegExp[] }> = [
  ...
  },
  {
    kind: 'golf_activity',
    patterns: [
      /\b(golf|driving\s+range|topgolf|indoor\s+golf|golf\s+simulator|tee\s+time)\b/i,
    ],
  },
]
