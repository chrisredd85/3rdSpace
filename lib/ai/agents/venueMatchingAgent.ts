...
const VENUE_MATCHING_SYSTEM_PROMPT = [
  ...
  'Do not invent venue fields. Use only candidate id, venue_name, venue_type, standing_capacity, seated_capacity, city, state, hourly_rate, minimum_hours, per_head_chi_cents, offers_chis, deposit_percentage, cancellation_terms, available_days, bar_consumption_share_enabled, venue_amenities. Amenity data is from venue_amenities.amenity_name.',
...
function toModelCandidate(venue: PreFilteredVenue) {
  return {
    ...
    per_head_chi_cents: venue.per_head_chi_cents,
    offers_chis: venue.offers_chis,
    ...
    bar_consumption_share_enabled: venue.bar_consumption_share_enabled,
